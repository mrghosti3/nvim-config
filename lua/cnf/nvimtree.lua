...
local function my_on_attach(bufnr)
    ...
    keymap('B',              api.filter.no_bookmark.toggle,      'Toggle No Buffer')
    keymap('c',              api.fs.copy.node,                   'Copy')
    keymap('C',              api.filter.git.clean.toggle,        'Toggle Git Clean')
    keymap('[c',             api.node.navigate.git.prev,         'Prev Git')
    keymap(']c',             api.node.navigate.git.next,         'Next Git')
    keymap('I',              api.filter.git.ignored.toggle,      'Toggle Git Ignore')
    ...
    keymap('F',              api.filter.live.clear,              'Clean Filter')
    keymap('f',              api.filter.live.start,              'Filter')
